# =======================================================================================================================================================================================================
# SUBJECT        : yellow pages - crawler to scrape industry details from yellow pages
# OBJECT TYPE    : python - BeautifulSoup
# OBJECT NAME    : py_ypages_industry_crwlr
# CREATED BY     : Harold Delaney
# CREATED ON     : 20190602
# SOURCE         : yellowpages [ https://www.yellowpages.com.au ]
# PREPERATION    : CRAWLER - python - BeautifulSoup - scrapes idustry listing details from site and stores in sqlite in preparation for etl
# FREQUENCY      : BI-ANNUAL
#               
# REMARKS        : 1) 
#                  2) 
...
def init():
    g['CLUE'] = 'real+estate+agents'
    g['URL'] = 'https://www.yellowpages.com.au/search/listings?clue=' + g['CLUE'] + '&eventType=pagination&locationClue=All+States&pageNumber='
    g['INDUSTRY'] = 'REAL ESTATE'
    g['CONFIG'] = pyConfig(g['CONFIG_FILE']).recs()
    g['PKG_PATH'] = path
    g['ENV'] = g['CONFIG']['ENV']
    # CHANGE - 20171128 ==================================================================================
    g['DB'] = g['CONFIG']['DB_DIR'] + g['CONFIG']['DB_NAB']
