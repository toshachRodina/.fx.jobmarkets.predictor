...
# CREATED ON     : 20170212
# SOURCE         : careerjet [ http://www.careerjet.co.nz/ ]
...
def scrape():
    ...
    for links in soup.find_all('a'):        
        ...
        if 'JOBS-' in link_txt.upper() and nbr_chk <= g['REGION_CHK_ID']: # if href matches what is considered relevant, do the following
