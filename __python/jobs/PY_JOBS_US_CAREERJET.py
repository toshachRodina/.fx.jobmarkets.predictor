...
# OBJECT NAME    : py_jobs_us_careerjet
# CREATED BY     : Harold Delaney
# CREATED ON     : 20170212
# SOURCE         : careerjet [ http://www.careerjet.com/ ]
...
#               
# REMARKS        : 1) NO API 
#                  2) this is parsing script data inot html page which beautifulsoup ignores (hens BS output differs from the browser html)
#                  3) some starting points/reading material
#                     https://groups.google.com/forum/#!topic/beautifulsoup/OyCDGYJkiWA
#                     http://stackoverflow.com/questions/21069294/parse-the-javascript-returned-from-beautifulsoup
#                     http://stackoverflow.com/questions/8020834/read-contents-of-script-with-beautifulsoup
#                     http://stackoverflow.com/questions/17597424/how-to-retrieve-the-values-of-dynamic-html-content-using-python
#                  4) where looping is required add time.sleep(2) (and import time to the top of the script)
# =======================================================================================================================================================================================================
# =============================================================================
...
def scrape():
    ...
    for links in soup.find_all('a'):        
        ...
        if 'JOBS-' in link_txt.upper(): #and nbr_chk <= region_id_chk: # if href matches what is considered relevant, do the following
            ...
            try:
                nbr = re.search(r'1 to(.*?)jobs', str(soup.encode("utf-8"))).group(1)
