...
OBJECT TYPE	 : table
OBJECT NAME     : ltn.dbo.f_dtl_jobsearch_au_careerjet_d
...
DROP TABLE ltn.dbo.stg_jobsearch_au_careerjet_raw;

CREATE TABLE ltn.dbo.stg_jobsearch_au_careerjet_raw
             (
...
DROP TABLE ltn.dbo.f_dtl_jobsearch_au_careerjet_d;

CREATE TABLE ltn.dbo.f_dtl_jobsearch_au_careerjet_d
             (
...
CREATE UNIQUE INDEX ux_f_dtl_jobsearch_au_careerjet_d ON ltn.dbo.f_dtl_jobsearch_au_careerjet_d(msmt_dte_id, job_category);

ALTER TABLE ltn.dbo.f_dtl_jobsearch_au_careerjet_d REBUILD
...
IF OBJECT_ID('create_f_dtl_jobsearch_au_careerjet_d') IS NULL -- Check if SP Exists
    EXEC ('CREATE PROCEDURE create_f_dtl_jobsearch_au_careerjet_d AS SET NOCOUNT ON;'); -- Create dummy/empty SP
GO

ALTER PROCEDURE create_f_dtl_jobsearch_au_careerjet_d -- Alter the SP Always
(
      @p_env      nvarchar(10)
...
=====================================================================================================================================================================================================*/
         ...
         SET @l_tbl_nme = 'f_dtl_jobsearch_au_careerjet_d';
         ...
         SET @l_msmt_dte_id =
             (
                 SELECT MAX(msmt_dte_id)
                        FROM
                             ltn.dbo.stg_jobsearch_au_careerjet_raw
             );
...
=================================================================================================*/
             ...
             CREATE TABLE #tmp_dtl_jobsearch_au_careerjet_s1
                          (
                          msmt_dte_id  int NOT NULL
                        , job_site_nme varchar(25) NOT NULL
                        , job_category varchar(255) NOT NULL
                 ...
                 (
                     SELECT rir.val_1
                            ...
                            WHERE 1 = 1
                                  ...
                                  AND rir.itm_rltshp_type_cde = 'AU_CAREERJET'
		  ...
		  SET @l_job_site_nme = 'CAREERJET';


             INSERT INTO #tmp_dtl_jobsearch_au_careerjet_s1
                    (msmt_dte_id
                   , job_site_nme 
                   , job_category
                   , job_count
             ...
             SELECT stg.msmt_dte_id
		        , @l_job_site_nme as job_site_nme
                  ...
                  , dbo.fn_getnumeric( REPLACE(UPPER(stg.job_count), @text_to_remove_job_count, '') ) AS job_count
                    FROM
                         ltn.dbo.stg_jobsearch_au_careerjet_raw AS stg;
...
=================================================================================================*/
             ...
             INSERT INTO ltn.dbo.f_dtl_jobsearch_au_careerjet_d
                    (msmt_dte_id
                   , job_site_nme
                   , job_category
                   , job_count
             ...
             SELECT s1.msmt_dte_id
		        , s1.job_site_nme
                  ...
                  , s1.job_count
                    FROM
                         #tmp_dtl_jobsearch_au_careerjet_s1 AS s1
                    WHERE 1 = 1;
