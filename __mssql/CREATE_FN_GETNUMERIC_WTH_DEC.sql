...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[fn_getnumeric_wth_dec]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
DROP FUNCTION [dbo].fn_getnumeric_wth_dec
GO

CREATE FUNCTION dbo.fn_getnumeric_wth_dec
                (
