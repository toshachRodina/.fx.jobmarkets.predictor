/*
=======================================================================================================================================================================================================
SUBJECT		 : py_vars_ctl - control/paramater table held in sqlite3 structure for control of python scripts
OBJECT TYPE	 : table
OBJECT NAME     : ltn.dbo.py_vars_ctl
...
DROP TABLE ltn.dbo.py_vars_ctl;

CREATE TABLE LTN.DBO.PY_VARS_CTL
...
ALTER TABLE ltn.dbo.py_vars_ctl REBUILD
WITH(DATA_COMPRESSION = ROW);

=======================================================================================================================================================================================================
exec create_py_vars_ctl   @p_env = 'DEV', @p_task_nme = 'CREATE_PY_VARS_CTL', @p_pkg_nme = 'PKG_PY_VARS_CTL'
...
IF OBJECT_ID('create_py_vars_ctl') IS NULL -- Check if SP Exists
    EXEC ('CREATE PROCEDURE create_py_vars_ctl AS SET NOCOUNT ON;'); -- Create dummy/empty SP
GO

ALTER PROCEDURE create_py_vars_ctl -- Alter the SP Always
(
      @p_env      nvarchar(10)
...
*/
         ...
         SET @l_tbl_nme = 'py_vars_ctl';
	    SET @l_stg_tbl_nme = 'stg_py_vars_ctl' 
...
*/
		  ...
		  INSERT INTO #TMP_PY_VARS_CTL ( ENV
								 , PKG_NME
								 , VAR_TYPE
								 , VAR_NME
								 , VAR_VAL
...
*/
		  TRUNCATE TABLE LTN.DBO.PY_VARS_CTL;

		  INSERT INTO LTN.DBO.PY_VARS_CTL ( ENV
								    , PKG_NME
								    , VAR_TYPE
								    , VAR_NME
								    , VAR_VAL
