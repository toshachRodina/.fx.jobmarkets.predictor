...
set dbpass=morganskye$1

:: Error log path - Important in debugging your issues
set errorLogPath="D:\ltndb_bak\dumperrors.txt"

:: MySQL EXE Path
set mysqldumpexe="C:\Program Files\MySQL\MySQL Server 8.0\bin\mysqldump.exe"

:: Error log path
set backupfldr=D:\ltndb_bak\

:: Path to data folder which may differ from install dir
set datafldr="M:\mySQL\Data"

:: Path to zip executable
set zipper="P:\PortableApps\PortableApps\7-ZipPortable\zipcmd\7za.exe"
